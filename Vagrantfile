...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "sethgrid-centos64"
  ...
  config.vm.hostname = "sethammons-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sethgrid-trial"
  #   chef.validation_client_name = "sethgrid-trial-validator"
  #   chef.validation_key_path = ".chef/sethgrid-trial-validator.pem"
  # end
end
